            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {
                    recipes.map(recipe => 
                        ...
                        <div className="card-body">
                          <h2 className="card-title text-xl font-semibold text-gray-800 font-medium">{recipe.recipe_name}</h2>
                          ...
                          <div className="card-actions ">
                            <button onClick={()=>addRecipeToQueue(recipe)} className="btn rounded-full bg-green-400 px-8 text-lg text-gray-800 mt-6
                            font-medium">Want To Cook</button>
                          </div>
                        </div>
                      </div>
                )
